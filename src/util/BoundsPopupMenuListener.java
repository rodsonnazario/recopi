...
public class BoundsPopupMenuListener implements PopupMenuListener {
	...
	/**
	 * Convenience constructore to allow the display of a horizontal scrollbar when
	 * required.
	 */
	 ...
	 * setPopupWider( true ) has been specified. A value of -1 indicates that there
	 * is no maximum.
	 *
	 ...
	 *
	 * @param popupAbove true display popup above the combo box, false display popup
	 *                   below the combo box.
	 */
